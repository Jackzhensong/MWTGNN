...
from torch_geometric.datasets import Planetoid, Amazon, WikipediaNetwork, Actor, LINKXDataset, Coauthor, DeezerEurope
...
def DataLoader(name):
    if name in ['cora_full', 'wiki_cooc', 'questions', 'roman_empire', 'amazon_ratings', 'squirrel_filtered',
        ...
        dataset = DeezerEurope(root='./data/deezer', transform=T.NormalizeFeatures())
    else:
